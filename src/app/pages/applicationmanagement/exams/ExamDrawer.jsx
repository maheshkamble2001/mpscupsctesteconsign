...
// 🚀 FIX: In components ko bahar nikal diya taaki React inhe baar baar recreate na kare aur scroll jump na ho
...
const InfoRow = ({
  ...
  <div className="flex items-center justify-between px-5 py-3.5 transition-colors hover:bg-slate-50/50">
    ...
    <span className={`text-right text-[14px] font-bold ${valueColor}`}>
                  ...
                  <div className="flex h-full flex-col bg-[#F8FAFC] shadow-2xl">
                    ...
                    <div className="z-10 flex items-center justify-between border-b border-slate-200/60 bg-white px-7 py-6 shadow-sm">
                      <div className="flex items-center gap-4">
                        <div className="flex h-[46px] w-[46px] shrink-0 items-center justify-center rounded-[14px] bg-[#0A0E17] text-[18px] font-bold text-white uppercase shadow-md">
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="mt-1 flex items-center gap-2">
                            ...
                            {e.Stage && (
                              <span className="inline-flex items-center rounded-full bg-orange-50 px-2.5 py-0.5 text-[10px] font-bold tracking-widest text-orange-600 uppercase">
                                {e.Stage}
                              </span>
                            )}
                          </div>
                      ...
                      <button
                        onClick={close}
                        className="rounded-full border border-slate-100 bg-slate-50 p-2 text-slate-400 transition-all hover:rotate-90 hover:bg-slate-100 hover:text-slate-700"
                      >

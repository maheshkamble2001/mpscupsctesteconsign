...
const InfoRow = ({ icon: Icon, iconColor = "text-blue-500", label, value, valueColor = "text-slate-900" }) => (
  <div className="flex items-center justify-between px-5 py-3.5 transition-colors hover:bg-slate-50/50">
    ...
    <span className={`text-[14px] font-bold text-right ${valueColor} max-w-[50%] truncate`} title={typeof value === 'string' ? value : ''}>
                  ...
                  <div className="flex h-full flex-col bg-[#F8FAFC] shadow-2xl">
                    ...
                    <div className="z-10 flex items-center justify-between border-b border-slate-200/60 bg-white px-7 py-6 shadow-sm">
                      <div className="flex items-center gap-4">
                        <div className="flex h-[46px] w-[46px] shrink-0 items-center justify-center rounded-[14px] bg-[#0A0E17] text-[18px] font-bold uppercase text-white shadow-md overflow-hidden">
                          {c.CoverImage ? (
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="mt-1 flex items-center gap-2">
                            ...
                            {c.ExamName && (
                              <span className="inline-flex items-center rounded-full bg-blue-50 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-widest text-blue-600">
                                {c.ExamName}
                              </span>
                            )}
                          </div>
                    ...
                    <div className="custom-scrollbar flex-1 overflow-y-auto px-7 py-8">
                      ...
                      <Section title="Course Details">
                        <InfoRow icon={TagIcon} iconColor="text-indigo-500" label="Tag Line" value={c.TagLine} />
                        <InfoRow icon={InformationCircleIcon} iconColor="text-blue-500" label="Description" value={c.Description} />
                        ...
                        <div className="flex items-center justify-between px-5 py-3.5 transition-colors hover:bg-slate-50/50">
                          ...
                          <span
                            className={`inline-flex items-center rounded-md px-2 py-1 text-[11px] font-bold uppercase ${
                              c.EMI ? "bg-emerald-50 text-emerald-600" : "bg-rose-50 text-rose-600"
                            }`}
                          >
                            {c.EMI ? "YES" : "NO"}
                          </span>
                      ...
                      <Section title="System Details">
                        ...
                        <div className="flex items-center justify-between px-5 py-3.5 transition-colors hover:bg-slate-50/50">
                          ...
                          <span
                            className={`inline-flex items-center rounded-md px-2 py-1 text-[11px] font-bold uppercase ${
                              c.status === 1 ? "bg-emerald-50 text-emerald-600" : "bg-slate-100 text-slate-500"
                            }`}
                          >

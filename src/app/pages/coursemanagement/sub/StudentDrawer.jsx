...
export function StudentDrawer({ isOpen, close, student }) {
  ...
  // Clean and reusable info row component
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <div className="divide-y divide-slate-50 rounded-xl border border-slate-50 bg-slate-50/30 px-3">
                            <InfoRow icon={EnvelopeIcon} label="Email ID" value={s.emailid} />
                            <InfoRow icon={PhoneIcon} label="Mobile" value={s.mobile} />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="divide-y divide-slate-50 rounded-xl border border-slate-50 bg-slate-50/30 px-3">
                            <InfoRow icon={CalendarDaysIcon} label="Admission Date" value={formatDate(s.admissiondate)} />
                            <InfoRow icon={CalendarDaysIcon} label="Added On" value={formatDate(s.addedon)} />
                            ...
                            <div className="flex items-center gap-3 py-2 px-1">
                              ...
                              <div className="flex flex-col">
                                ...
                                <Badge 
                                  color={s.status === 1 ? "success" : "warning"} 
                                  variant="soft" 
                        ...
                        <div>
                          ...
                          <div className="divide-y divide-slate-50 rounded-xl border border-slate-50 bg-slate-50/30 px-3">
                            <InfoRow icon={MapIcon} label="State ID / Name" value={s.stateid} />
                            <InfoRow icon={MapPinIcon} label="City" value={s.city} />
                            <InfoRow icon={HomeIcon} label="Address" value={s.address} />
                          </div>
                        </div>
